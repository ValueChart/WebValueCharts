...
* @Last Modified time: 2016-12-31 21:44:38
*/
...
describe('Users Routes', () => {
	...
	describe('Route: /Users', () => {
		...
		describe('Method: Post', () => {
			...
			context('when the username in question is not taken', () => {
				...
				it('should return a status object with the new user\'s username, password, and login status as well as status code 201', (done: any) => {
			...
			context('when the username in question is taken', () => {
				...
				it('should return status code 401', (done: any) => {
					user.post('Users').send(testUser)
	...
	describe('Route: Users/login', () => {
		...
		describe('Method: Post', () => {
			...
			context('when the username and password supplied are correct', () => {
				it('should successfully log the user in, and the return a status object with the username, password, and login status as well as status code 200', (done: any) => {
			...
			context('when the username is correct but the password is not', () => {
				it('should fail to log the user in, and return status code 401', (done: any) => {
	...
	describe('Route: Users/logout', () => {
		...
		describe('Method: Get', () => {
			...
			it('should log the user out and return a status object with their username, password, and logout status, as well as status code 200', (done: any) => {
	...
	describe('Route: /Users/:user', () => {
		...
		context('when the user is not logged in', () => {
			...
			describe('Method: Get', () => {
				...
				it('should return status code 401 as the user is not authorized', (done: any) => {
		...
		context('when the user is logged in', () => {
			...
			describe('Method: Get', () => {
				...
				it('should return the user resource and status code 201', (done: any) => {
					user.get('Users/' + testUser.username)
						.set('Accept', 'application/json')
						.expect('Content-Type', /json/)
						.expect(200)
			...
			describe('Method: Put', () => {
				...
				it('should change the details of the user\'s account', (done: any) => {
					user.put('Users/' + testUser.username).send({ username: testUser.username, password: 'DifferentPassword', email: 'differentEmail@different.com' })
						.set('Accept', 'application/json')
						.expect('Content-Type', /json/)
						.expect(200)
	...
	describe('Route: /Users/:user/ValueCharts', () => {
		...
		context('when the user is not logged in', () => {
			...
			describe('Method: Get', () => {
				...
				it('should retrieve the ValueCharts associated with the logged-in user as well as status code 200', (done: any) => {
