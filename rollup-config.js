...
* @Last Modified time: 2017-07-09 18:25:13
*/
...
export default {
  ...
  plugins: [
      ...
      commonjs({
        ...
        namedExports: {
          './node_modules/lodash/lodash.js': [ 'isNumber', 'differenceWith', 'differenceBy', 'isNil', 'clone', 'cloneDeep', 'isEqual', 'clamp', 'findIndex' ]
        }
      }),
      uglify()
  ]
