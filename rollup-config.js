...
* @Last Modified time: 2017-08-16 16:50:44
*/
...
export default {
  ...
  plugins: [
      ...
      commonjs({
        ...
        namedExports: {
          './node_modules/lodash/lodash.js': [ 'uniqueId', 'xor', 'isNumber', 'differenceWith', 'differenceBy', 'isNil', 'clone', 'cloneDeep', 'isEqual', 'clamp', 'findIndex' ]
        }
      }),
      uglify()
  ]
