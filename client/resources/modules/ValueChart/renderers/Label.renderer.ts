...
export class LabelRenderer {
	...
	*/
	createLabels(u: RendererUpdate, labelData: LabelData[], labelContainer: d3.Selection<any, any, any, any>, parentName: string = LabelDefinitions.ROOT_CONTAINER_NAME): void {
