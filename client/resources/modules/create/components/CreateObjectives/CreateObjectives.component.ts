...
export class CreateObjectivesComponent implements OnInit {
	...
	// Map color strings from old version to Hex codes (TODO: remove after updating DB)
	...
	*/
	objectiveToObjRow(obj: Objective, parentID: string, depth: number) {
		...
		if (obj.objectiveType === 'abstract') {
			...
			// If the color is a name, convert to Hex code (TODO: remove after updating DB)
			let color = (<PrimitiveObjective>obj).getColor();
