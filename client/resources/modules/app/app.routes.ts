...
export const APP_ROUTER_PROVIDERS = [
	[AuthGuardService, JoinGuardService, CurrentUserService, ValueChartHttpService, ValueChartService, ChartUndoRedoService, CreationStepsService, ValidationService]
];
